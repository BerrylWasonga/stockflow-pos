        ...
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select class="form-control js-example-basic-single" id="products" x-ref="product">
                            ...
                            <option product_name="{{ $product->product->name}}"
                                ...
                                $product->product->name }} - <span>Purchase Price: @ksh($product->purchase_price)</span></option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="total">Total <small class="text-info">[Ksh]</small></label>
                        <input type="number" class="form-control" id="total" x-ref="total" name="total"
                            placeholder="Total Purchase Cost">
                    </div>
                    <div class="form-group">
                        <label for="paid">Paid <small class="text-info">[Ksh]</small></label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Due<small class="text-info">[Ksh]</small></label>
        ...
        <div class="col-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button x-ref="createInvoiceBtn" id="createInvoiceBtn" style="display: none; margin-top: 10px;" type="submit"
                        class="btn btn-primary btn-sm btn-block">Create Invoice</button>
                </div>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function() {
        ...
        $('#products').select2({
            ...
            $('#invoiceTable').append(`<tr id="row-${i}" x-ref="row-${i}" class="border-bottom border-dark single-product">
                ...
                <td>
                    <input class="invoice-input" type="text" name="products[${i}][serial_no]" placeholder="Serial No" maxlength="100">
                </td>
                <td>
