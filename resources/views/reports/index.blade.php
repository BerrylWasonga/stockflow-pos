...
<div class="card">
    ...
    <div class="card-body">
        <table class="GeneratedTable">
            <thead>
                <tr>
                    <th class="text-center" colspan="2"><i>{{ $settings->shop_name ?? 'Shop Name' }}</i><br>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>@ksh((int) $report['totalSellAmount'])</td>
                </tr>
                <tr>
                    <th>Total Paid Amount</th>
                    <td>@ksh((int) $report['totalSellAmount'] - (int) $report['totalDueAmount'])</td>
                </tr>
                <tr>
                    <th>Total Due Amount</th>
                    <td>@ksh((int) $report['totalDueAmount'])</td>
                </tr>
                <tr>
                    <th>Total Profit</th>
                    <td>@ksh((int) $report['profit'])</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>Total Expense</th>
                    <td>@ksh((int) $report['totalExpense'])</td>
                </tr>
                <tr>
