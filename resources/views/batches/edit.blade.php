        ...
        <div class="col-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="paid_amount">Payable Amount <small class="text-info">[Ksh]</small></label>
                    ...
                    <h6 class="text-info">Due Amount: <span class="text-danger" x-text="due_amount"></span> Ksh</h6>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Per Unit Purchase Price <small
                                class="text-info">[Ksh]</small></label>
                    ...
                    <div class="form-group">
                        <label for="name">Total Purchase Cost <small class="text-info">[Ksh]</small></label>
                    ...
                    <div class="form-group">
                        <label for="paid_amount">Paid Amount <small class="text-info">[Ksh]</small></label>
                        <input type="number" class="form-control" id="paid_amount" placeholder="Paid Amount"
                    ...
                    <div class="form-group">
                        <label for="due_amount">Due Amount <small class="text-info">[Ksh]</small></label>
                ...
                <div class="card-body">
                    <table>
                        ...
                        <tr>
                            <th>Unit Price</th>
                            <td>:</td>
                            <td>@ksh($batch->purchase_price)</td>
                            <td class="text-info">Ksh</td>
                        </tr>
                        <tr>
                            <th>Status</th>
                        ...
                        <tr>
                            <th>Total</th>
                            <td>:</td>
                            <td>@ksh($batch->total_purchase_cost)
                        ...
                        <tr>
                            <th>Paid</th>
                            <td>:</td>
                            <td>@ksh($batch->total_purchase_cost - $batch->due_amount) <span class="text-info"
                        ...
                        <tr>
                            <th>Due</th>
                            <td>:</td>
                            <td width="250">@ksh($batch->due_amount) <span class="text-danger"
